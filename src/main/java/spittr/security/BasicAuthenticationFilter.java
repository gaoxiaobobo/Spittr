...
public class BasicAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request,
		...
		try {
			// header = 'Basic Base64Encode(username:password)'
			...
			// 2.  Pass along to AuthenticationManager instance
			// 3.  Eventually compared via appropriate AuthenticationProvider			
